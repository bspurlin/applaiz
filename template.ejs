<table>
  <tbody>
    <tr class="indexhead">
        <th class="indexcolicon"><img src="/icons/blank.gif"></th>
        <th class="indexcolname" id="dirname">
	    <%let aa=obj.dirname.split("/")%><%= aa[aa.length - 1]%>
	</th>
	<th>
	</th>
     </tr>
    ...
    <tr >
        ...
        <td class="dirselector" path=<%= obj.parent %> id="parent">Parent Directory
	</td>
    </tr>
