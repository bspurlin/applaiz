...
<%
let list = obj.html.trim().replace(/^<ul>/,'<ul id="newlist"><li id="litop"><span class="topspan"   path="." id="parent-a"    >  <img src="/icons/back.gif" class="newbackimg" /> New!    </span><span  class="topspan" id="header3"></span> <span  class="topspan" id="headerdirname"></span></li>');
 %>
